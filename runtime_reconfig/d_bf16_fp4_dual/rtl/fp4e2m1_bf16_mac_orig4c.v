...
// =============================================================
// fp4e2m1_bf16_mac_orig4c
//   Reinterprets FP4 (E2M1) lane pairs as BF16 operands by zero-padding
//   the exponent/mantissa fields, then reuses bf16_mac_orig4c for the math.
//   - Keeps original interface/latency (4-cycle, II=1 via bf16_mac_orig4c)
//   - mode conversions are purely combinational in front of bf16_mac_orig4c
// =============================================================
module fp4e2m1_bf16_mac_orig4c (
    input  wire        clk,
