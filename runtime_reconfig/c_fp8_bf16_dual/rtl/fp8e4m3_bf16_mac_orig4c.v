...
module fp8e4m3_bf16_mac_orig4c (
    input  wire        clk,
    input  wire [31:0] a18,
    input  wire [15:0] b18,
    input  wire [63:0] c64,
  ...
  bf16_add_orig4c u_add11 (.clk(clk), .a16(prod11_bf16), .b16(c11_s3), .c16(sum11_bf16));
  bf16_add_orig4c u_add12 (.clk(clk), .a16(prod12_bf16), .b16(c12_s3), .c16(sum12_bf16));
  bf16_add_orig4c u_add21 (.clk(clk), .a16(prod21_bf16), .b16(c21_s3), .c16(sum21_bf16));
  bf16_add_orig4c u_add22 (.clk(clk), .a16(prod22_bf16), .b16(c22_s3), .c16(sum22_bf16));
