...
module int8_bf16_mac_orig4c (
  ...
  mac_mapper_bf16_orig4c u_map_bf16 (
    .clk               (clk),
    .a32               (a32),
    .b16               (b16),
  ...
  mac_postproc_int8_orig4c u_pp_int8 (
    .clk                 (clk),
    .sign_hi_int8_s1     (sign_hi_int8_s1),
    .sign_lo_int8_s1     (sign_lo_int8_s1),
  ...
  mac_postproc_bf16_orig4c u_pp_bf16 (
    .clk               (clk),
    .exp_hi_bf16_s1    (exp_hi_bf16_s1),
    .exp_lo_bf16_s1    (exp_lo_bf16_s1),
    .sign_hi_bf16_s1   (sign_hi_bf16_s1),
  ...
  bf16_add_orig4c u_bf16_add_hi (
    .clk (clk),
    .a16 (prod_hi16_bf16),
    .b16 (c_hi_bf16_s2),
    .c16 (bf16_hi_sum_s4)
  );
  bf16_add_orig4c u_bf16_add_lo (
    .clk (clk),
    .a16 (prod_lo16_bf16),
    .b16 (c_lo_bf16_s2),
    .c16 (bf16_lo_sum_s4)
