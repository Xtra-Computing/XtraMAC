...
//`define FP8E4_MAC32_TB_USE_SIMPLE_DSP

`ifdef FP8E4_MAC32_TB_USE_SIMPLE_DSP
module dsp_usage (
  input  wire        clk,
  input  wire [26:0] a,
  input  wire [17:0] b,
...
module tb_fp8e4m3_bf16_32_mac;
  ...
  initial begin
    ...
    A_vec[N]      = 16'h4038;
    B_vec[N]      = 16'hBF80;
    C_vec[N]      = {32'h00000000, 32'hBFC00000};
    EXP_HI_vec[N] = 32'hC0000000;
    EXP_LO_vec[N] = 32'hC0200000;
    N = N + 1;
    ...
    EXP_HI_vec[N] = 32'h40C80000;
    EXP_LO_vec[N] = 32'h40B80000;
    N = N + 1;
    ...
    A_vec[N]      = 16'h3C82;
    B_vec[N]      = 16'h3F00;
    C_vec[N]      = {32'h3F400000, 32'hBF000000};
    EXP_HI_vec[N] = 32'h3FC00000;
