...
////////////////////////////////////////////////////////////////////////////////
// Testbench: tb_fp4e2m1_fp8e4m3_mac
////////////////////////////////////////////////////////////////////////////////
module tb_fp4e2m1_fp8e4m3_mac;
  ...
  function [7:0] fp4e2m1_to_fp8e4m3;
    input [3:0] fp4;
    reg sign;
    reg [1:0] exp2;
    reg frac1;
    ...
    begin
      ...
      frac1 = fp4[0];
      if (exp2 == 2'b11) begin
        fp4e2m1_to_fp8e4m3 = QNAN8;
      end else if (exp2 == 2'b00) begin
        fp4e2m1_to_fp8e4m3 = {sign, 7'd0};
      end else begin
        exp_final  = exp2 + 4;
  ...
  initial begin
    ...
    for (idx = 0; idx < N; idx = idx + 1) begin
      a1_fp8 = fp4e2m1_to_fp8e4m3(avec[idx][3:0]);
      a2_fp8 = fp4e2m1_to_fp8e4m3(avec[idx][7:4]);
  ...
  initial begin
    ...
    $display("\n--- FP4(E2M1) x FP8(E4M3) MAC (LAT=%0d, Vectors=%0d) ---", LAT, N);
