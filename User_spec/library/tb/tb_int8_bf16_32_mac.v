...
//`define INT8_MAC32_TB_USE_SIMPLE_DSP

`ifdef INT8_MAC32_TB_USE_SIMPLE_DSP
module dsp_usage (
  input  wire        clk,
  input  wire [26:0] a,
  input  wire [17:0] b,
...
module tb_int8_bf16_32_mac;
  ...
  initial begin
    ...
    EXP_HI_vec[N] = 32'h41300000;
    EXP_LO_vec[N] = 32'hC0A00000;
    N = N + 1;

    A_vec[N]      = 16'hF807;
    B_vec[N]      = 16'hBF00;
    C_vec[N]      = {32'hBF800000, 32'h3F000000};
    EXP_HI_vec[N] = 32'h40400000;
    EXP_LO_vec[N] = 32'hC0400000;
    N = N + 1;
    ...
    A_vec[N]      = 16'h7F80;
    B_vec[N]      = 16'h3FC0;
    C_vec[N]      = {32'h41200000, 32'hC1200000};
    EXP_HI_vec[N] = 32'h43488000;
    EXP_LO_vec[N] = 32'hC34A0000;
    N = N + 1;

    A_vec[N]      = 16'h4020;
    B_vec[N]      = 16'hBF80;
    C_vec[N]      = {32'hC0A00000, 32'h40A00000};
    EXP_HI_vec[N] = 32'hC28A0000;
    EXP_LO_vec[N] = 32'hC1D80000;
    N = N + 1;

    A_vec[N]      = 16'hFF01;
    B_vec[N]      = 16'h3E80;
    C_vec[N]      = {32'h3E000000, 32'hBE000000};
    EXP_HI_vec[N] = 32'hBE000000;
    EXP_LO_vec[N] = 32'h3E000000;
    N = N + 1;

    A_vec[N]      = 16'h03FD;
    B_vec[N]      = 16'h4080;
    C_vec[N]      = {32'h40C00000, 32'h40C00000};
    EXP_HI_vec[N] = 32'h41900000;
    EXP_LO_vec[N] = 32'hC0C00000;
    N = N + 1;

    A_vec[N]      = 16'hF614;
    B_vec[N]      = 16'hC000;
    C_vec[N]      = {32'h40000000, 32'hC0000000};
    EXP_HI_vec[N] = 32'h41B00000;
    EXP_LO_vec[N] = 32'hC2280000;
    N = N + 1;

    A_vec[N]      = 16'h32C4;
    B_vec[N]      = 16'h3F40;
    C_vec[N]      = {32'hBFC00000, 32'h3FC00000};
    EXP_HI_vec[N] = 32'h42100000;
    EXP_LO_vec[N] = 32'hC22E0000;
    N = N + 1;
