...
//     S1 mapper  : fp8_mac_s1_prep / bf16_mac_s1_prep
//     S2 postproc: fp8_mac_postproc / mac_postproc_bf16
//     S3 adders  : shared bf16_add instances
...
module fp8_bf16_dual_mac (
  ...
  // ===========================================================
  // S3: shared BF16 adders (bf16_add has internal register)
  // ===========================================================
  ...
  bf16_add u_add0 (.clk(clk), .a16(add_a0), .b16(add_b0), .c16(sum_lane0_s3));
  bf16_add u_add1 (.clk(clk), .a16(add_a1), .b16(add_b1), .c16(sum_lane1_s3));
  bf16_add u_add2 (.clk(clk), .a16(add_a2), .b16(add_b2), .c16(sum_lane2_s3));
  bf16_add u_add3 (.clk(clk), .a16(add_a3), .b16(add_b3), .c16(sum_lane3_s3));
