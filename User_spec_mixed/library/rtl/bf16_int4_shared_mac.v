...
// =============================================================
// bf16_int4_shared_mac
//   - Combined INT4×BF16+BF16 and BF16×BF16+BF16 MAC
//   - Shared DSP48 pipeline
//   - Pipeline: S1 mapper (bf16/int4) -> S2 postproc -> S3 bf16_add -> S4 out reg
...
module bf16_int4_shared_mac (
  ...
  int4_bf16_mac_s1_mapper u_s1_int4 (
      .clk(clk),
  ...
  // ---- S3 lane packing + specials (reused from bf16_mac) ----
...
// =============================================================
module int4_bf16_mac_s1_mapper (
    input  wire        clk,
