...
// =============================================================
// bf16_fp32_mac_2lane : 2-lane BF16 x BF16 + FP32 -> FP32
//   - Uses bf16_fp32_mul_2lane for the multiplier
...
//   - II = 1
// =============================================================
module bf16_fp32_mac_2lane #(
    parameter MUL_LAT    = 2,  // multiplier latency (1 or 2)
    parameter MID_STAGES = 1,  // pipeline regs between mul and add
  ...
  // ----------------------------------------------------------------
  // Multiplier: 2-lane BF16 x BF16 -> FP32
  // ----------------------------------------------------------------
  ...
  // ----------------------------------------------------------------
  // Mid-pipeline stages (between mul output and add input)
  // ----------------------------------------------------------------
